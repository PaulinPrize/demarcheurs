...
@section('content')
    @include('partials.message', ['url' => route('user.message.refuse')])
                ...
                @foreach ($messages as $message)
                    <tr id="{{ $message->id }}">
                        ...
                        <td class="float-right">
                            <a class="btn btn-success btn-sm" href="{{ route('user.message.approve', $message->id) }}" role="button" data-toggle="tooltip" title="Approuver le message"><i class="fas fa-thumbs-up"></i></a>
